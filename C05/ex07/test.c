...
/*   Updated: 2024/08/31 23:20:51 by mimelo-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(TEST_ARGS)
{
	...
	TEST(assert_int(ft_find_next_prime(4), 5, "next prime 5"));
	TEST(assert_int(ft_find_next_prime(-2), 2, "next prime -2"));
	TEST(assert_int(ft_find_next_prime(2147483646), 2147483647, "next prime 2147483646"));
